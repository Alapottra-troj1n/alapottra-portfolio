  ...
  const textLeave = () => setCursorVariant('default');
    ...
    return (
          <div className="mt-20 flex  flex-col justify-center items-center">
            ...
            <a href="https://github.com/Alapottra-troj1n" rel="noopener noreferrer" target="_blank" ><FaGithub className="text-2xl hover:text-yellow-400 "  /></a>
            <a href="https://www.linkedin.com/in/alapottra" rel="noopener noreferrer" target="_blank" ><FaLinkedin className="text-2xl hover:text-yellow-400"  /></a>
            <a href="https://www.facebook.com/Alapottra" rel="noopener noreferrer" target="_blank" ><FaFacebook className="text-2xl hover:text-yellow-400"  /></a>
