        ...
        <div class="card lg:w-96 glass m-5">
            ...
            <div class="card-body">
                ...
                <div class="card-actions justify-center">
                    <a rel="noopener noreferrer" target="_blank" href={project.livelink}><FaExternalLinkAlt className="text-white mx-2 hover:text-yellow-400  text-xl cursor-pointer" /></a>
                    <a rel="noopener noreferrer" target="_blank" href={project.github}><FaGithub className="text-white mx-2 hover:text-yellow-400  text-xl cursor-pointer" /></a>
